...
<html lang="en">
  ...
  <script>
    $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Question '+i+'</label><div class="col-sm-10"><input type="text" class="form-control" name="question'+i+'" value="<?php echo $row['question1'];?>" ><input type="text" class="form-control" name="answer'+i+'" value="<?php echo $row['answer1'];?>"></div>');  	
	  });    
 });  
      $(function(){
