...
<html>
 ...
 <div class="box">
     <!--<div class="container">-->
       <h2 align="center">Pictures in Profile: <?php echo ucfirst($valuestr); ?></h2>
       <br />
...
<br>
<br>
   <h2 align="center">Videos in Profile: <?php echo ucfirst($valuestr); ?></h2>
<br>
...
<br>
<br>
   <h2 align="center">Music in Profile: <?php echo ucfirst($valuestr); ?></h2>
<br>
